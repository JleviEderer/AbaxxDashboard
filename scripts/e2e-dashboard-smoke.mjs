...
async function main() {
  ...
  try {
    ...
    try {
      ...
      await page.getByRole("heading", { name: "Weekly market volume" }).waitFor();
      ...
      // Controls are collapsed by default; expand to verify they exist
      ...
      // Changing Focus product activates compare mode immediately
